export default function sketch (p) {
  ...
  p.drawFace = function (x, y, i) {
    p.drawPettal(0, 0, faces[i].pettalSpacing, faces[i].pettalWidth, faces[i].pettalLength, faces[i].pettalColour); //remove the y
    ...
    p.drawMouth(0,0, faces[i].pettalColour,faces[i].mouth,faces[i].centerSize);
    //  p.drawKawaii();
  }
  ...
  p.arc(0,size/5,size/5,size/5, 0, Math.PI);
